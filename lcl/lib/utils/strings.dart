class Strings {
  ...
  static const String MODE_PREFERENCE = "Mode";
   ...
   static const LEGAL_DISCLOSURE = "Legal disclosure";
   static const LEGAL_DISCLOSURETEXT = "Information according to § 5 TMG APPiness Solutions UG Stresemannstraße 77a 22769 Hamburg\n\nCommercial register: 12345xxx \nRegister court: Hanstestadt Hamburg\n\nRepresented by:\nMyriam Fennell\n\nContact\nPhone: +49(0)17666425220 E-mail: lunchalize@gmail.com\n\nValue added tax ID\nSales tax identification number according to § 27 a sales tax law: 123456789xxxxx\n\nResponsible for the content according to § 55 Abs. 2 RStV Myriam Fennell\n\nEU Dispute Resolution\nThe European Commission provides an online dispute resolution (OS) platform: https://ec.europa.eu/consumers/odr.You will find our e-mail address at the top of the imprint.Consumer dispute resolution/Universal Arbitration BodyWe are not willing or obliged to participate in dispute resolution proceedings before a consumer arbitration board.\n\nLiability for contents\nAs a service provider, we are responsible for our own content on these pages according to § 7 para.1 TMG (German Telemedia Act) and general laws. According to §§ 8 to 10 TMG we are not obliged to monitor transmitted or stored information from third parties or to investigate circumstances that indicate illegal activity.Obligations to remove or block the use of information according to general laws remain unaffected by this. However, liability in this respect is only possible from the time of knowledge of a concrete infringement. If we become aware of any such legal infringements, we will remove the content in question immediately.Liability for links\nOur offer contains links to external websites of third parties, on whose contents we have no influence. Therefore we cannot assume any liability for these external contents. The respective provider or operator of the sites is always responsible for the contents of the linked sites. The linked pages were checked for possible legal violations at the time of linking. Illegal contents were not identified at the time of linking.However, a permanent control of the contents of the linked pages is not reasonable without concrete evidence of a violation of the law. If we become aware of any infringements, we will remove such links immediately.\n\nCopyright\nThe contents and works on these pages created by the site operators are subject to German copyright law. The reproduction, editing, distribution and any kind of use outside the limits of copyright law require the written consent of the respective author or creator. Downloads and copies of these pages are only permitted for private, non-commercial use.Insofar as the content on this site was not created by the operator, the copyrights of third parties are observed. In particular, third-party content is identified as such. Should you nevertheless become aware of a copyright infringement, please inform us accordingly. If we become aware of any infringements, we will remove such contents immediately.";

  static const String PHOTOTIP0 = "Photography Tips";

  static const String PHOTOTIP1 = "Dresser";
  static const String PHOTOTIP2 = "To make the photographed dish look extra tasty, you should take some time with the set-up. Please don't be messy, but drape everything nicely. For example, you can arrange your food in a circle, triangle or line and garnish it with herbs, spices, berries, flowers, etc. It is also advisable not to overcook some ingredients and then place them as decoration. ";
  static const String PHOTOTIP3 = "Background";
  static const String PHOTOTIP4 = "Please do not throw anything away! It is always nice to arrange the dish on special plates, bowls, boards etc. Cast iron pans, fine wine glasses or silver cutlery can also create atmosphere. Flea markets are great for this - most of the rarities there are real bargains.";
  static const String PHOTOTIP5 = "Lighting";
