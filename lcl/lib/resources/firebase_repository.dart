...
class FirebaseRepository {
  ...
  Future<User> fetchUserById(String id) => _firebaseMethods.fetchUserById(id);
  ...
  Future<void> fetchLoggedUserSettings(FirebaseUser user) =>
      _firebaseMethods.fetchLoggedUserSettings(user);
  ...
  Future<String> fetchUserNameById(String userId) =>
      _firebaseMethods.fetchUserNameById(userId);
